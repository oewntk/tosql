...
ALTER TABLE ${semrelations.table} ADD KEY        `k_@{semrelations.table}_@{semrelations.lu2id}`      (${semrelations.lu2id});
ALTER TABLE ${semrelations.table} ADD KEY        `k_@{semrelations.table}_@{semrelations.word2id}`    (${semrelations.word2id});
